...
public class TickerWebSocketService {
    ...
    public TickerWebSocketService(KafkaSender kafkaSender) {
    ...
    public void init() {
        ...
        WebSocketListener listener = new WebSocketListener() {
            ...
            public void onOpen(WebSocket webSocket, Response response) {
                System.out.println("✅ Ticker WebSocket 연결 성공!");
            ...
            public void onMessage(WebSocket webSocket, ByteString bytes) {
                try {
                    ...
                    kafkaSender.send("ticker", logMessage);
    ...
    private static void sendSubscriptionMessage(WebSocket webSocket) throws IOException {
        List<Object> subscribeMsg = List.of(
                ...
                new SubscriptionType("ticker", markets)
        );
